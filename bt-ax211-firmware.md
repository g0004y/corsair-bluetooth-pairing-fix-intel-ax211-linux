...
The firmware files are available in my GitHub repository:
...
**[Download the Windows driver from GitHub](https://github.com/vik-the-guy)**
...
1. Download `BT-22.130.0-32-64UWD-Win10-Win11.exe` from the GitHub repository
